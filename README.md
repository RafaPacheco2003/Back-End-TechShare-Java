...
**TechShare API** es el backend para una plataforma de intercambio de conocimientos y recursos para desarrolladores. Este proyecto está construido con **Java** y el ecosistema de **Spring Boot**, siguiendo las mejores prácticas para crear una API RESTful robusta, segura y escalable.
